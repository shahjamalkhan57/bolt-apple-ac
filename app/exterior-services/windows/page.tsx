...
import { ArrowRight, Phone, Chrome as Home, Shield, Zap, Eye, Wrench, CircleCheck as CheckCircle, DollarSign } from "lucide-react";
  ...
  const windowTypes = [
    {
      ...
      description:
        "Classic double-hung windows with both sashes that move up and down for excellent ventilation control.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Large, fixed windows designed to maximize natural light and provide expansive views of the outdoors.",
    },
    {
  ...
  const benefits = [
    {
      ...
      description:
        "Energy-efficient windows reduce heating and cooling costs while improving indoor comfort.",
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: "Enhanced Security",
      description:
        "Modern windows with advanced locking systems provide better security for your home.",
    },
    {
      icon: <Eye className="h-6 w-6" />,
      title: "Natural Light",
      description:
        "Quality windows maximize natural light while providing clear, unobstructed views.",
    },
    {
      icon: <Home className="h-6 w-6" />,
