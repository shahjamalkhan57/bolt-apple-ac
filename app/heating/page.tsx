  ...
  const services = [
    {
      ...
      description:
        "Professional installation of high-efficiency furnaces tailored to your home&apos;s specific needs.",
      icon: <Flame className="h-6 w-6" />,
    },
    {
      title: "Furnace Repair",
      description:
        "Quick diagnosis and repair services for all furnace issues to restore your comfort as soon as possible.",
      icon: <Wrench className="h-6 w-6" />,
    },
    {
      title: "Furnace Maintenance",
      description:
        "Regular tune-ups to keep your heating system running efficiently and prevent costly breakdowns.",
      icon: <CheckCircle className="h-6 w-6" />,
    },
    {
      title: "24/7 Emergency Service",
      description:
        "Round-the-clock availability for those unexpected heating emergencies that can&apos;t wait.",
      icon: <Clock className="h-6 w-6" />,
    },
  ];
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              ...
              >
                Is it cold outside and you just noticed your HVAC system
                isn&apos;t warming up your house? Call Apple AC & Heat for
                furnace heating repairs and replacement in Rockwall, TX.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              From installation to maintenance and emergency repairs, we keep
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold">
                Dallas Furnace Repair
              </h2>
              <div className="w-20 h-1.5 bg-gradient-to-r from-[#be1d1d] to-[#0f1724] rounded-full"></div>
              <p className="text-lg text-gray-700">
                Routine maintenance is vital to the lifespan, efficiency, and
                safety of your heating system. At Apple AC & Heat, we champion
                these regular checks as a preventive measure against untimely
                breakdowns, especially during the cold season.
              </p>
              <p className="text-lg text-gray-700">
                Consistent maintenance enhances your system&apos;s
                functionality, leading to reliable heating and energy
                efficiency, which results in lower energy costs. By identifying
                minor issues early, we prevent them from escalating into larger
                problems, saving you time and money.
              </p>
              <p className="text-lg text-gray-700">
                Moreover, regular checks ensure your system operates safely,
                eliminating potential hazards like carbon monoxide leaks.
              </p>
              <p className="text-lg text-gray-700 font-semibold">
                Trust Apple AC & Heat for comprehensive maintenance, securing
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <motion.p
              ...
              className="text-lg text-gray-600"
            >
              While routine maintenance is crucial, there might be times when
              your heating system will exhibit signs of needing immediate
              attention
            </motion.p>
          </div>
          ...
          >
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-6">
              At Apple AC & Heat, we urge homeowners to reach out at the first
              sign of trouble. Prompt attention to these warning signs can
              prevent minor issues from becoming major problems, ensuring your
              home remains warm and comfortable through the colder months.
            </p>
            <Link
              href="tel:2147897262"
              className="inline-flex items-center gap-2 bg-[#0f1724] hover:bg-[#0f1724]/90 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold">
                Heating Repair & Replacement Service
              </h2>
              <div className="w-20 h-1.5 bg-gradient-to-r from-[#be1d1d] to-[#0f1724] rounded-full"></div>
              ...
              <div className="bg-red-50 dark:bg-[#be1d1d]/10 rounded-xl p-6 border border-red-100 dark:border-[#be1d1d]/20">
                ...
                <p className="text-gray-700">
                  Cold temperatures outside have you worried? Our experienced
                  technicians provide quick and efficient repair services for
                  various heating issues, ensuring your unit operates at peak
                  performance and prolonging its lifespan.
                </p>
              </div>

              <p className="text-lg text-gray-700">
                However, if your system is old or frequently malfunctioning, an
                HVAC furnace replacement might be more practical. A new heating
                system is more energy-efficient, consistently heats your home,
                and minimizes the risk of frequent breakdowns.
              </p>

              <p className="text-lg text-gray-700">
                If this is the best course of action for you, we will expertly
                guide you through the replacement process, helping you select
                the perfect system tailored to your needs and budget.
              </p>
      ...
      <section className="py-20 bg-[#be1d1d] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Are you tired of bearing the discomfort of a malfunctioning HVAC
              system? Wait no longer. Apple AC & Heat is at your service, ready
              to restore the optimal functioning of your system. Our skilled
              technicians provide quick and efficient repair, maintenance, and
              replacement services to ensure you have a comfortable living
              environment, no matter the weather outside.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-xl mb-8"
            >
              What&apos;s more, we are renowned for our transparent pricing. We
              provide fair and competitive quotes, without any hidden fees.
              Contact us today for a free quote, and let our expert team take
              care of your HVAC system. Don&apos;t compromise your comfort;
              reach out to us and let Apple AC & Heat provide you with the
              reliable HVAC service you deserve.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
