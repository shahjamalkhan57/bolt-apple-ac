...
export const metadata: Metadata = {
  ...
  description: "Expert heating services, furnace repair, and installation in Rockwall, TX. 24/7 emergency heating repair available. Licensed HVAC contractors serving Dallas-Fort Worth.",
  keywords: "heating services, furnace repair, furnace installation, HVAC heating, Rockwall TX, emergency heating repair, Dallas Fort Worth",
  openGraph: {
    title: "Professional Heating Services | Apple AC & Heat",
    description: "Keep your home warm with expert heating services in Rockwall, TX. Furnace repair, installation, and maintenance by licensed professionals.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Professional Heating Services | Apple AC & Heat",
    description: "Expert heating services, furnace repair, and installation in Rockwall, TX. 24/7 emergency service available.",
