...
const navItems = [
  {
    ...
    children: [
      ...
      {
        label: "Shingles (Asphalt, Metal, Slate, Tile)",
        href: "/roofing-services/shingles",
      },
      { label: "Hail Damage Repair", href: "/roofing-services/hail-damage" },
      {
        label: "Emergency Tarping (24/7)",
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Drywall & Ceiling Repairs",
        href: "/interior-restoration/drywall-ceiling",
      },
      {
        label: "Leak-related Damage",
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Urgent Leak Repairs",
        href: "/emergency-services/leak-repairs",
      },
    ],
  },
  {
...
export default function Header() {
  ...
  return (
    <>
                ...
                <div key={item.label} className="relative group">
                  {item.children ? (
                    <div className="flex items-center">
                      <span className="px-3 py-2 text-gray-700 dark:text-gray-200 hover:text-[#be1d1d] dark:hover:text-[#be1d1d] font-medium rounded-md flex items-center gap-1 group cursor-pointer">
                        {item.label}
                      </span>
                      <button
      ...
      <div
        className={cn(
          "fixed top-0 right-0 h-full w-full max-w-sm bg-white dark:bg-gray-900 lg:hidden transition-transform duration-300 ease-in-out z-50 shadow-2xl",
              ...
              {navItems.map((item) => (
                ...
                >
                  {item.children ? (
                    ...
                    <Link
                      href={item.href}
                      className="block py-3 text-lg font-medium hover:text-[#be1d1d] dark:hover:text-[#be1d1d] transition-colors"
                      onClick={toggleMenu}
                    >
                      {item.label}
                    </Link>
