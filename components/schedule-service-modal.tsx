  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="group relative overflow-hidden rounded-full bg-white border-2 border-primary-600 px-6 py-4 text-primary-600 shadow-lg transition-transform hover:scale-105 active:scale-95">
