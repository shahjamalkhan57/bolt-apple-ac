  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 z-[9999] bg-[#0f1724] text-white p-4 rounded-full shadow-lg hover:bg-[#0f1724]/90 transition-all duration-300",
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-[#0f1724] p-4 flex items-center justify-between text-white">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              ...
              >
                ...
                <button
                  ...
                  className="bg-[#0f1724] text-white p-2 rounded-full hover:bg-[#0f1724]/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
