      ...
      {isVisible && (
        <div className="relative">
          <motion.div
            ...
            className="bg-gradient-to-r from-primary-600 to-primary-500 text-white overflow-hidden z-50"
          >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="p-1 hover:bg-primary-700/20 rounded-full transition-colors"
